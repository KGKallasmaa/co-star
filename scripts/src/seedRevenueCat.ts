...
const PROJECT_NAME = "Co-Star for Founders";

const PRODUCT_IDENTIFIER = "founders_pro_monthly";
const PLAY_STORE_PRODUCT_IDENTIFIER = "founders_pro_monthly:monthly";

const PRODUCT_DISPLAY_NAME = "Founders Pro Monthly";
const PRODUCT_USER_FACING_TITLE = "Founders Pro";
const PRODUCT_DURATION = "P1M";

const APP_STORE_APP_NAME = "Co-Star for Founders iOS";
const APP_STORE_BUNDLE_ID = "com.costarfounders.ios";
const PLAY_STORE_APP_NAME = "Co-Star for Founders Android";
const PLAY_STORE_PACKAGE_NAME = "com.costarfounders.android";
...
async function seedRevenueCat() {
  ...
  else console.log("App with test store found:", app.id);
  ...
  if (priceError) {
    ...
    console.log("Successfully added test store prices ($9.99/mo)");
  }
